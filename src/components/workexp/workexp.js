...
const WorkExp = () => (
    <section className="workexp page-container">
        {/* <h2 className="resume__title"><i className="fa fa-briefcase" /> Work Experience</h2> */}

        <ul className="resume__list list-unstyled">
            <li className="exp">
                <div className="exp__header">
                    <img className="exp__img" src="/imgs/pdhi/logo.jpg" alt="" />
                ...
                <ul className="exp__details">
                    ...
                    <li>
                        Refactored our JS architecture, allowing the creation of modular
                        knockout components
                    </li>
                    <li>
                        Lead the initiative to convert our nested CSS structures into a
                        modular BEM standard
                    </li>
                    <li>
